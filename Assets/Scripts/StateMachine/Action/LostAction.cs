...
[CreateAssetMenu(fileName = "NewLostAction", menuName = "State Machine/Actions/LostAction")]
public class LostAction : StateAction
{
    ...
    private void Lost(StateMachineController controller)
    {
        ...
        if (controller.target != null)
        {
            Quaternion targetRotation =
                Quaternion.LookRotation(Vector3.ProjectOnPlane(controller.target.position - controller.eyes.position,
                    Vector3.up));
